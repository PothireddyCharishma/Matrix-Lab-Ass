    ...
    return (
      <div className="left-container">
        <div className="left-main-container">
          <div className="nftify-main-container">
            <div className="nftify-container">
              <svg
              ...
              <h1 className="nftify-head">NFTify</h1>
            </div>
            <button
              onClick={this.changeToPair}
              type="button"
              className={
                activeTabId === 'TOKEN'
                  ? 'button-nftify-highlight-container'
                  : 'button-nftify-container'
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h1 className="token-head">Token Address</h1>
            </button>
            <button
              onClick={this.changeToToken}
              type="button"
              className={
                activeTabId === 'PAIR'
                  ? 'button-nftify-highlight-container'
            ...
            >
              {/* <AiFillBuild className="token-image" /> */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <h1 className="token-head">Pair Address</h1>
            </button>
          </div>
          <div className="facebook-twitter-main-container">
            <div className="facebook-twitter-container">
              <AiFillFacebook className="facebook-image" />
              <AiFillLinkedin className="facebook-image" />
              <AiFillTwitterSquare className="facebook-image" />
            </div>
          </div>
        </div>
      </div>
